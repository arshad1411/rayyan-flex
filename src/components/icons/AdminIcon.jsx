...
const AdminIcon = ({
  ...
  return (
    ...
    >
      <path
        d="M13.605 16.2151C12.945 16.4101 12.165 16.5001 11.25 16.5001H6.75002C5.83502 16.5001 5.05502 16.4101 4.39502 16.2151C4.56002 14.2651 6.56252 12.7275 9.00002 12.7275C11.4375 12.7275 13.44 14.2651 13.605 16.2151Z"
        stroke={color}
        strokeWidth="1.5"
        strokeLinecap="round"
